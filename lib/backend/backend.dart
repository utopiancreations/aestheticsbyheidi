...
export 'schema/art_record.dart';
export 'schema/users_record.dart';
export 'schema/followers_record.dart';

/// Functions to query ArtRecords (as a Stream and as a Future).
Future<int> queryArtRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ArtRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ArtRecord>> queryArtRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
    ...
    queryCollection(
      ArtRecord.collection,
      ArtRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ArtRecord>> queryArtRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
